...
RUN GPG_KEYS=8B0C5E32536032F79A3DCED9E1AFA550C7D3C49A \
    ...
    && apk --no-cache add --virtual .build-deps \
        ...
        gnupg \
        unzip \
    && curl -fSL https://github.com/v2ray/v2ray-core/releases/download/v2.45/v2ray-linux-64.zip -o v2ray.zip \
    && unzip v2ray.zip \
    && rm v2ray.zip \
    ...
    gpg --batch --verify v2ray.sig v2ray \
